        ...
        <MaxWidthWrapper className="flex items-center justify-between">
          <div className="flex items-center space-x-12">
            <Link href="/" className="flex items-center gap-x-2">
              <Icons.logo className="w-6 h-6 text-brand-red-light fill-brand-red-dark" />
              <h1 className="text-lg font-bold font-heading uppercase text-foreground">KATALYST</h1>
            </Link>
